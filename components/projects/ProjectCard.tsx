...
export function ProjectCard({ project, onExplain }: ProjectCardProps) {
  return (
    <motion.article
    ...
    >
      ...
      {onExplain && (
        <button
          ...
          className="flex items-center gap-2 text-sm text-ai-glow hover:text-ai-glow/80 transition-colors group/btn"
        >
