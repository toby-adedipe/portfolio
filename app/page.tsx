...
import { getProfile, getProjects, getExperience } from "@/lib/content";
...
export default async function Home() {
  ...
  return (
    <>
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 bg-surface border border-border text-text-primary font-medium rounded-lg hover:border-accent/50 hover:text-accent transition-colors"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
          ...
          <footer className="py-8 border-t border-border">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-text-secondary">
              ...
              <p className="flex items-center gap-2">
                ...
                +
                <span className="text-ai-glow">AI</span>
              </p>
            </div>
          </footer>
        </div>
      ...
      <ClientWrapper name={profile.name} />
    </>
  );
}
